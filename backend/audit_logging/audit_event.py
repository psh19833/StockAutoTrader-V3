...
class AuditEventType(str, Enum):
    ...
    WS_TRADE_TICK_RECEIVED = "WS_TRADE_TICK_RECEIVED"
    WS_ORDER_BOOK_RECEIVED = "WS_ORDER_BOOK_RECEIVED"
    WS_FILL_NOTICE_RECEIVED = "WS_FILL_NOTICE_RECEIVED"
    WS_MARKET_STATUS_RECEIVED = "WS_MARKET_STATUS_RECEIVED"
    WS_EXPECTED_EXECUTION_RECEIVED = "WS_EXPECTED_EXECUTION_RECEIVED"
